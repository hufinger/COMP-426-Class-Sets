...
export async function fn1() {
    let response = await axios("https://comp426fa19.cs.unc.edu/a08/heroes", {type: "GET"});
...
export async function fn2() {
    let response = await axios("https://comp426fa19.cs.unc.edu/a08/heroes", {type: "GET", params: {sort: "first ASC"}});
...
export async function fn3() {
    let response = await axios({method: "POST", url: "https://comp426fa19.cs.unc.edu/a08/users", data: {first: "Hunter", last: "Finger", onyen: "hufinger"}});
    return response;
};
...
export async function fn4() {
  try{
    let response = await axios({method: "POST", url: "https://comp426fa19.cs.unc.edu/a08/users", data: {first: "Hunter", onyen: "hufinger"}});
    return response;
  }catch(error){
    console.log(error);
  }
...
export async function fn5() {
    let response = await axios({method: "PUT", url: "https://comp426fa19.cs.unc.edu/a08/headers", headers: {"my-custom-request-header": "Hello, World!"}});
    return response;
};
...
export async function fn6() {
  let response = await axios({method: "GET", url: "https://comp426fa19.cs.unc.edu/a08/headers"});
